...
|------|------|-----------------|--------|
| T1 | `Hao0321/claude-skill-code-cleanup` | Single SKILL.md at code-cleanup-helper/SKILL.md, zero companion files | 2026-06-25 — steps 3/4/5/6 pass; step 2 not gradeable (agent recall) |
...
|------|------|------|-----|---------|------------|
| 2026-06-25 | `Hao0321/claude-skill-code-cleanup` | T1 | Claude Code (Docker) | Steps 3/4/5/6 ✅; Step 2 not gradeable — agent recall | `runs/2026-06-25-hao0321-claude-skill-code-cleanup/` |
